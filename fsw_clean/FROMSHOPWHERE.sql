-- FROMSHOPWHERE — Database Setup
-- Import file này vào phpMyAdmin

SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";
SET NAMES utf8mb4;

CREATE DATABASE IF NOT EXISTS `FROMSHOPWHERE`
...
-- Admin: admin@fromshopwhere.com / admin123
INSERT INTO `users` (`ho_ten`,`email`,`mat_khau`,`vai_tro`) VALUES
('Admin FSW','admin@fromshopwhere.com','$2y$10$eImiTXuWVxfM37uY4JANjQe5kF3W9befy5rkILSJ6.D7lQqIEPTmy','admin');
...
('Thiết kế','thiet-ke','Phần mềm đồ họa và thiết kế sáng tạo',1),
('Văn phòng','van-phong','Bộ công cụ văn phòng Microsoft & Google',2),
('Video','video','Phần mềm dựng phim và chỉnh sửa video',3),
('Bảo mật','bao-mat','Phần mềm diệt virus và bảo vệ dữ liệu',4);
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `slug` (`slug`),
  KEY `fk_cat` (`danh_muc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `products`
  (`danh_muc_id`,`ten_san_pham`,`slug`,`mo_ta`,`gia_goc`,`gia_ban`,`phien_ban`,`hinh_anh`,`la_moi`) VALUES
(1,'Adobe Photoshop 2025','adobe-photoshop-2025','Phần mềm chỉnh sửa ảnh chuyên nghiệp hàng đầu thế giới.',440000,350000,'v26.0','products/photoshop-2025.jpg',0),
(1,'Adobe Illustrator 2025','adobe-illustrator-2025','Thiết kế vector chuyên nghiệp với AI tích hợp.',NULL,290000,'v29.0','products/illustrator-2025.jpg',1),
(1,'Canva Pro','canva-pro','Thiết kế đồ họa online dễ dùng, hàng ngàn template.',230000,180000,'2024','products/canva-pro.jpg',0),
(1,'Autodesk AutoCAD 2025','autodesk-autocad-2025','Phần mềm CAD tiêu chuẩn ngành kiến trúc và kỹ thuật.',1200000,890000,'2025','products/autocad-2025.png',0),
(1,'CorelDRAW 2024','coreldraw-2024','Bộ phần mềm thiết kế đồ họa vector chuyên nghiệp.',600000,480000,'24.0','products/CorelDRAW-2024.jpg',0),
(2,'Microsoft Office 365','microsoft-office-365','Bộ ứng dụng văn phòng Word, Excel, PowerPoint đầy đủ.',NULL,280000,'2024','products/office-365.jpg',0),
(2,'Microsoft Windows 11 Pro','microsoft-windows-11-pro','Hệ điều hành Windows 11 bản quyền chính hãng.',550000,450000,'23H2','products/windows-11-pro.jpg',0),
(2,'Microsoft Visio 2024','microsoft-visio-2024','Vẽ sơ đồ, quy trình và biểu đồ chuyên nghiệp.',NULL,520000,'2024','products/ms-visio-2024.jpg',1),
(3,'Adobe Premiere Pro 2025','adobe-premiere-pro-2025','Phần mềm dựng phim chuyên nghiệp của Adobe.',400000,320000,'v24.0','products/premiere-pro-2025.jpg',0),
(3,'Adobe After Effects 2025','adobe-after-effects-2025','Tạo hiệu ứng chuyển động và motion graphics.',NULL,310000,'v24.0','products/after-effects-2025.jpg',0),
(3,'Wondershare Filmora 13','wondershare-filmora-13','Phần mềm dựng phim thân thiện cho người mới.',NULL,199000,'v13.6','products/filmora-13.jpg',1),
(3,'Vegas Pro 22','vegas-pro-22','Dựng video và audio chuyên nghiệp trên PC.',450000,360000,'v22.0','products/vegas-pro-22.jpg',0),
(3,'Topaz Video AI','topaz-video-ai','Nâng cấp chất lượng video bằng AI thông minh.',800000,650000,'v5.0','products/topaz-video-ai.jpg',0),
(4,'Kaspersky Total Security','kaspersky-total-security','Bảo vệ toàn diện máy tính khỏi virus và mã độc.',280000,220000,'2025','products/kaspersky-total.png',0),
(4,'Norton 360 Deluxe','norton-360-deluxe','Bảo mật đa nền tảng với VPN và quản lý mật khẩu.',NULL,240000,'2025','products/norton-360.jpg',1),
(4,'Bitdefender Total Security','bitdefender-total-security','Antivirus số 1 thế giới về khả năng phát hiện mã độc.',260000,210000,'2025','products/bitdefender-total.png',0);
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_orders_users` (`nguoi_dung_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `order_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_items_orders` (`don_hang_id`),
  KEY `fk_items_products` (`san_pham_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
UPDATE `posts` SET `hinh_anh`='blog/may-tinh-cham-diet-virus.jpg' WHERE slug='bai-viet-1';
UPDATE `posts` SET `hinh_anh`='blog/dan-sang-tao-adobe.jpg'       WHERE slug='bai-viet-2';
UPDATE `posts` SET `hinh_anh`='blog/may-tinh-cham-diet-virus.jpg' WHERE slug='bai-viet-3';
UPDATE `posts` SET `hinh_anh`='blog/huong-dan-mua-phan-mem.jpg'   WHERE slug='bai-viet-4';
UPDATE `posts` SET `hinh_anh`='blog/huong-dan-mua-phan-mem.jpg'   WHERE slug='bai-viet-5';
UPDATE `posts` SET `hinh_anh`='blog/toi-uu-lap-trinh.jpg'         WHERE slug='bai-viet-6';
UPDATE `posts` SET `hinh_anh`='blog/toi-uu-lap-trinh.jpg'         WHERE slug='bai-viet-7';
UPDATE `posts` SET `hinh_anh`='blog/huong-dan-mua-phan-mem.jpg'   WHERE slug='bai-viet-8';
UPDATE `posts` SET `hinh_anh`='blog/khong-gian-luu-tru.png'       WHERE slug='bai-viet-9';
UPDATE `posts` SET `hinh_anh`='blog/bi-quyet-phan-mem.png'        WHERE slug='bai-viet-10';
